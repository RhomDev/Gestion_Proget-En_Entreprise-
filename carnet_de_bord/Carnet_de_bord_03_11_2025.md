...
### Jeu 1: Pourquoi la maladie ?
	- __Objectif__ : Un jeu video ou un personnage voyage dans le colon d'un être humaim, et essaye de deviner pourquoi il est malade avec les differents indices
...
### Jeu 3: En Entreprise ! (version employeur)
	...
	- ** Objectif **: 3-5 joueurs(chefs de secteur) decident ensemble(ou non) des actions à un employé pour réaliser leur tache(personnel ou collectif) 
...
### Jeu 4: Sensibilisation IA 
	...
	- ** Objectif **: Voir les effet négatifs de l'IA dans le monde professionnel et dans la vie de tous les jours
	- ** Type de Jeu **: plateau, transmettre un savoir, Règle, imprimable et gratuit
	- ** Joueur Cible **: prés ado
	- ** Cadre **: sensibilisation grand public
	- ** Durée **: 60-80min
	
### Jeu 5: Puzzle emploi du temps

	- ** Objectif **: Remplir l'emploi de temps de la semaine d'un étudiant de Master Automatique Robotique en faisant en sorte que tout rentre
	- ** Type de Jeu **: tuile, organisation, assemblage, Régle, demander au créateur gratuit
	- ** Joueur Cible **: enfant/élève
	- ** Cadre **: enseignement et formation
	- ** Durée **: 0-20min
